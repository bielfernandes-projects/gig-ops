...
* **Abrir repertório no show**: na página do show (`/gigs/[id]`), o botão "Abrir repertório" leva a `/repertorio/lista/[id]` (blocos, tons, "começa em" em amarelo, tons pedidos e observações). O antigo modo palco (`/palco/[id]`) foi removido por enquanto (recuperável pelo histórico do git).
