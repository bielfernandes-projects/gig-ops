...
* **Migration:** `supabase/migrations/20260926000100_tour_seen_at.sql` — `alter table public.go_profiles add column if not exists tour_seen_at timestamptz;`. **Precisa ser aplicada** (Management API, como as outras); até lá o `select` da coluna volta erro, o app trata como "não viu" e o tour abre — degrada sem quebrar.
...
* **Migration:** `supabase/migrations/20260926000200_limpeza_legado_fase0.sql`. **Precisa ser aplicada.**
...
* **Migration:** `supabase/migrations/20260926000300_drop_go_profiles_role.sql`. Idempotente.
