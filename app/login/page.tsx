      ...
      <div className="w-full max-w-sm bg-zinc-900 border border-zinc-800 rounded-2xl shadow-2xl p-8 flex flex-col items-center">
        ...
        {successMsg ? (
          ...
          <>
            ...
            {!isLogin && (
              <div className="w-full flex flex-col items-center mt-6 pt-6 border-t border-zinc-800/80">
                <span className="text-xs text-zinc-500 uppercase tracking-widest mb-4 font-bold">Ou então</span>
                <button disabled className="w-full py-3 px-4 bg-indigo-600 border border-indigo-500 text-white font-bold rounded-xl flex items-center justify-center gap-2 opacity-60 cursor-not-allowed shadow-md">
                  ✨ Criar Minha Própria Banda <span className="uppercase text-[9px] tracking-wider ml-1 px-1.5 py-0.5 bg-indigo-800 rounded">(Premium)</span>
                </button>
                <p className="text-[10px] text-zinc-500 font-medium text-center mt-2 max-w-[250px]">
                  Seja o administrador da sua própria agenda e convoque seus músicos. (Em breve)
                </p>
              </div>
            )}
          </>
