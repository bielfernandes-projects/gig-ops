...
export default function RootLayout({
  ...
  return (
    <html lang="pt-BR">
      <body className={`${inter.className} min-h-screen bg-zinc-950 text-zinc-50 flex flex-col antialiased`}>
        ...
        {/* Main Content Area */}
        <main className="flex-1 md:ml-64 w-full flex flex-col pb-20 md:pb-0">
          {children}
        </main>
